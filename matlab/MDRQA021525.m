function [RP, RESULTS]=MDRQA021525(data,tau,dim,param,threshold,options)
arguments
    data double
...
switch param
    case 'rad'
        [recurrence, diag_hist, vertical_hist,A] = linehist(data,a,threshold,'mdrqa');
    case 'rec'
        radius_start = 0.01;
        radius_end = 0.5;
        [recurrence, diag_hist, vertical_hist, radius, A] = setradius(data,a,radius_start,radius_end,threshold,'mdrqa',options.Iter);
end
