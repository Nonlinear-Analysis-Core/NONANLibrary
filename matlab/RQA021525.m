function [RP, RESULTS]=RQA021525(data,tau,dim,param,threshold,options)
arguments
...
switch param
    case 'rad'
        [recurrence, diag_hist, vertical_hist,A] = linehist(data,a,threshold,'rqa');
    case 'rec'
        radius_start = 0.01;
        radius_end = 0.5;
        [recurrence, diag_hist, vertical_hist, radius, A] = setradius(data,a,radius_start,radius_end,threshold,'rqa',options.Iter);
end
